...
namespace SuperMarioBrothers.Items
{
    class OneUpMushroom : AbstractItem
    {
        ...
        private OneUpMushroomPhysics physics;


        public OneUpMushroom(Vector2 currentLocation, int scale = DataLibrary.ITEM_SCALE)
        {
            currentSprite = SpriteFactory.Instance.GetOneUpMushroomSprite();
            ...
            physics = new OneUpMushroomPhysics(this);
        }
