...
namespace SuperMarioBrothers.Items
{
    class Star : AbstractItem
    {
        ...
        private const int width = DataLibrary.DEFAULT_SIZE - 4;
        private const int height = DataLibrary.DEFAULT_SIZE;
        private int maxHeight;
        private StarPhysics physics;

        public Star(Vector2 currentLocation, int scale = DataLibrary.ITEM_SCALE)
        {
            currentSprite = SpriteFactory.Instance.GetStarSprite();
