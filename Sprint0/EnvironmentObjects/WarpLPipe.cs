...
{
    class WarpLPipe : AbstractEnvironmentObject
    {
        private Rectangle destinationRectangle;
        private ISprite currentSprite;

        private const int width = DataLibrary.DEFAULT_SIZE * 2;
        private const int height = DataLibrary.DEFAULT_SIZE * 2;

        public WarpLPipe(Vector2 currentLocation, int scale = DataLibrary.PIPE_SCALE)
        {
            currentSprite = SpriteFactory.Instance.GetWrapLPipeSprite();
