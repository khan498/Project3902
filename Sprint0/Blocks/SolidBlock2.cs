...
{
    class SolidBlock2 : AbstractBlock
    {
        ...
        public SolidBlock2(Vector2 currentLocation, int scale = DataLibrary.BLOCK_SCALE)
        {
            currentSprite = SpriteFactory.Instance.GetSolidBlock2Sprite();
